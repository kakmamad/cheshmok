...
//
var DefaultApplicationName = ["me.cheshmak.cordova", "CheshmakApplication"].join('.');
...
module.exports = function(context) {
   ...
   if(applicationNode.get('android:name') === undefined){
      ...
      console.warn("It looks like your application's android:name has already been set. If you have not set it up for Cheshmak.Push, please refer to the Advanced Configuration section of this plugin's README.");
   }
